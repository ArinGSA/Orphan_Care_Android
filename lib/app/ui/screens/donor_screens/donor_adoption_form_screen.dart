  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: CustomAppBar(
          title:
              "${trustData.forWhom ?? ""} ${Constants.adoptionApplicationForm}",
      ...
      try {
        var requestAdoptionData = TrustAdoptRequestModel(
            ...
            maritalStatus:
                trustController.trustAdoptRequestModel.maritalStatus ??
                    "Single",
            whomAdopt: trustData.forWhom);
        await commonController.putDataBaseByKey(
            requestAdoptionData,
            Constants.orphanDataBase,
            "${trustData.phoneNumber}-${Constants.donorAdoptionRequestDataKey}-${donorController.donorSignUPModel.phoneNumber}");
        Get.back();
