    ...
    try {
      for (var element in dataBase.keys) {
        if (element.contains(Constants.trustProfileDataKey)) {
          ...
          trustController.localTrustList.forEach((element) {
      ...
      print(trustController.localTrustList.length);
      print("++++++++++++++");
          ...
          : ListView.separated(
              ...
              itemBuilder: (context, index) {
                return CommonTrustComponent(
                  ...
                  forWhom: trustController.localTrustList[index].forWhom ?? "-",
                  phNumber: trustController.localTrustList[index].phoneNumber!,
